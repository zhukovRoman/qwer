...
<fieldset>
 ...
 <?php echo $form->textFieldRow($model, 'title', array('hint'=>'Название видео. Должен отражать суть видеоряда.')); ?>
    <?php echo $form->textFieldRow($model, 'subtitle', array('hint'=>'Подзаголовок должен давать более полное представление о содержании видеоролика.')); ?>
     ...
     <div class="control-group ">
        ...
        <div id="widget" style ="display: <?php echo ($model->preview_url!='') ? 'none' : 'block'?> ">
            ...
            $this->widget('ext.EAjaxUpload.EAjaxUpload',
             ...
             <p class="help-block">Картинка, которая будет отображаться на главной.<br> Если оставить пустой, то будет присвоено превью видео.</p>
         </div>
     </div>   
