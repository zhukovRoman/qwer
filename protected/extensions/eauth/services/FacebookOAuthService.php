...
class FacebookOAuthService extends EOAuth2Service {	
	...
	protected function fetchAttributes() {
		...
		$this->attributes['gender'] = $info->gender == 'Male' ? 0 : 1;
		
	//	$this->attributes['email'] = $info->email;
		$this->attributes['birth_date'] = $info->birthday;
		
		// You can even try to get a user's picture
		$this->attributes['picture'] = "http://graph.facebook.com/{$info->username}/picture?type=large";
		$this->attributes['userpic'] = "http://graph.facebook.com/{$info->username}/picture?type=square";
	}
